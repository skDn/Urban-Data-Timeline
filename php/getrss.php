...
//    echo $responseData['response'];
    ...
    $returnArray = [];
    $output = array_slice($responseData['response']['serviceJson']['users'], 0, 20,true);
//    for ($x = 0; $x <= 20; $x++) {
//        echo '<br>'.$responseData['response']['serviceJson']['users'][$x]['count'];
//        echo '<br>'.$responseData['response']['serviceJson']['users'][$x]['screen_name'];
//        array_push($returnArray, $responseData['response']['serviceJson']['users'][$x]);
//    }
